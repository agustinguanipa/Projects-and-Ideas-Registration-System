...
?>
		...
		<table class="table table-striped table-hover">
			...
			<tbody>	
	          ...
	          <td class='text-center'>
							<a href="javascript:void(0)" onclick="lookUsuario('<?php echo $row['ident_usua']; ?>')"  class="look" data-toggle="modal"><i class="fa fa-eye" data-toggle="tooltip" title="Ver"></i></a>
	          </td>
						<td class='text-center'>
							<a href="#"  data-target="#editUsuarioModal" class="edit" data-toggle="modal" data-nombr_usua="<?php echo $nombr_usua?>" data-apeli_usua="<?php echo $apeli_usua?>" data-gener_usua="<?php echo $gener_usua?>" data-civil_usua="<?php echo $civil_usua?>" data-nivel_usua="<?php echo $nivel_usua?>" data-telef_usua="<?php echo $telef_usua?>" data-email_usua="<?php echo $email_usua?>" data-estad_usua="<?php echo $estad_usua?>" data-munic_usua="<?php echo $munic_usua?>" data-direc_usua="<?php echo $direc_usua?>" data-usuar_usua="<?php echo $usuar_usua?>" data-ident_usua="<?php echo $ident_usuario; ?>"><i class="fa fa-edit" data-toggle="tooltip" title="Editar" ></i></a>
	          </td>
	          <td class='text-center'>
							<a href="#deleteUsuarioModal" class="delete" data-toggle="modal" data-ident_usua="<?php echo $ident_usuario;?>"><i class="fa fa-trash" data-toggle="tooltip" title="Eliminar"></i></a>
	          </td>
					</tr>
					<?php }?>
					<tr>
	...
	<div id="divModalLookUsuario"></div>
    <script>
      function lookUsuario(ident_usua) {
          var ruta = '../../paginas/administrador/modal_usuario_ver.php?ident_usua=' + ident_usua;
          $.get(ruta, function (data) {
              $('#divModalLookUsuario').html(data);
              $('#lookUsuarioModal').modal('show');
          });
      }
    </script>
