<?php
  ...
  $ident_usua = mysqli_real_escape_string($con,(strip_tags($_POST["edit_ident_usua"],ENT_QUOTES)));
	$ident_proy=intval($_POST['edit_id']);

    $sql = "UPDATE tab_proy SET nombr_proy='".$nombr_proy."', desco_proy='".$desco_proy."', descr_proy='".$descr_proy."', areaa_proy='".$areaa_proy."', motor_proy='".$motor_proy."', ident_usua='".$ident_usua."' WHERE ident_proy='".$ident_proy."' ";
