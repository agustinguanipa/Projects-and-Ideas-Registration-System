		...
		<table class="table table-striped table-hover">
			...
			<tbody>	
	          ...
	          <td class='text-center'>
						...
						<td class='text-center'>
							<a href="#"  data-target="#editProyectoAdminModal" class="edit" data-toggle="modal" data-nombr_proy="<?php echo $nombr_proy?>" data-desco_proy="<?php echo $desco_proy?>" data-descr_proy="<?php echo $descr_proy?>" data-areaa_proy="<?php echo $areaa_proy?>" data-motor_proy="<?php echo $motor_proy?>" data-ident_usua="<?php echo $ident_usua?>" data-ident_proy="<?php echo $ident_proyecto; ?>"><i class="fa fa-edit" data-toggle="tooltip" title="Editar" ></i></a>
	          </td>
	          <td class='text-center'>
							<a href="#deleteProyectoAdminModal" class="delete" data-toggle="modal" data-ident_proy="<?php echo $ident_proyecto;?>"><i class="fa fa-trash" data-toggle="tooltip" title="Eliminar"></i></a>
	          </td>
					</tr>
					<?php }?>
					<tr>
