...
<!-- Modal Add Proyecto Usuario -->
  
<div id="addProyectoUsuarioModal" class="modal fade">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form name="add_proyecto_usuario" id="add_proyecto_usuario" class="justify-content-center" align="center" action="" enctype="multipart/form-data" method="POST">
...
<div id="editProyectoUsuarioModal" class="modal fade">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form name="edit_proyecto_usuario" id="edit_proyecto_usuario" class="justify-content-center" align="center" enctype="multipart/form-data" method="POST">
        <div class="modal-header">            
...
<div id="deleteProyectoUsuarioModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <form name="delete_proyecto_usuario" id="delete_proyecto_usuario">
        <div class="modal-header">            
          <h4 class="modal-title">Borrar Proyecto</h4>
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        </div>
        <div class="modal-body">          
          <p>¿Seguro que quieres borrar este registro?</p>
          <p class="text-danger"><small>Se borrará el Proyecto.</small></p>
...
<div id="restaurarProyectoUsuarioModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <form name="restaurar_proyecto_usuario" id="restaurar_proyecto_usuario">
        <div class="modal-header">            
