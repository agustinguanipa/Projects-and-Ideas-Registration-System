...
<div id="addUsuarioModal" class="modal fade">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form name="add_usuario" id="add_usuario" class="justify-content-center" align="center" action="" enctype="multipart/form-data" method="POST">
            ...
            <div class="col-1 form-group">
              <label class="form-label" for="tipce_usua"><b>Tipo: </b></label>
...
<div id="editUsuarioModal" class="modal fade">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form name="edit_usuario" id="edit_usuario" class="justify-content-center" align="center" enctype="multipart/form-data" method="POST">
        <div class="modal-header">            
...
<div id="restaurarUsuarioModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <form name="restaurar_usuario" id="restaurar_usuario">
        <div class="modal-header">            
