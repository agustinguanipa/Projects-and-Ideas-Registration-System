	    ...
	    <div class="card-deck">
			    ...
			    <h5>Información Personal</h5>
					  ...
					  <div class="form-row">
					      ...
					      <label class="form-label" for="cedul_usua">Cédula de Identidad: </label><br>
					    ...
					    <div class="col form-group">
					      ...
					      <label><?php echo $data_user['nombr_usua']; ?></label>
					    </div>
					    <div class="col form-group">
					      <label class="form-label" for="apeli_usua">Apellido: </label><br>
					      <label><?php echo $data_user['apeli_usua']; ?></label>
					    </div>
					  </div>
					  <div class="form-row">
					  	<div class="col form-group">
					    ...
					    <div class="col form-group">
					      <label class="form-label" for="gener_usua">Estado Civil: </label><br>
					      <label><?php echo $data_user['civil_usua']; ?></label>
					    </div>
					    <div class="col form-group">
					      <label class="form-label" for="nivel_usua">Nivel de Instrucción: </label><br>
					      <label><?php echo $data_user['nivel_usua']; ?></label>
					    </div>
					  </div>
					  <div class="form-row">
					    <div class="col form-group">
